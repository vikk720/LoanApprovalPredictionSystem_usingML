...
def ValuePredictor(data = pd.DataFrame):
	# Model name
	model_name = r'C:\Users\acer\Desktop\loan-approval-prediction-main\bin\xgboostModel.pkl'
...
def predict():
	if request.method == 'POST':
		...
		schema_name = r'C:\Users\acer\Desktop\loan-approval-prediction-main\data\columns_set.json'
